...
class ErrorCollector {
  ...
  throw(): never { throw new AggregateError(this.errors); }
}
```
...
5. **Don't Swallow Errors**: Never use empty catch blocks.

## Common Pitfalls
- **Catching Too Broadly**: `except Exception` can hide bugs.
