...
- **Caching**: Implement multi-layer caching (CDN, Redis, In-Memory) to reduce database load.
- **Database Optimization**: Use indexing, read-replicas, and query optimization techniques.
- **Asynchronous Processing**: Offload heavy tasks to message queues (RabbitMQ, Kafka, SQS).
- **Graceful Shutdown**: Always handle SIGTERM and SIGINT to prevent data loss or connection dropping.

## Resiliency
- Implement Circuit Breakers for external dependencies.
- Retry with Exponential Backoff for transient failures.
- Rate limit APIs to prevent DoS attacks.
