...
CREATE INDEX idx_database_rows_workspace_schema
  ON database_rows(workspace_id, schema_key)
  WHERE is_deleted = false;

CREATE INDEX idx_database_rows_page
  ON database_rows(page_id)
  WHERE is_deleted = false;

CREATE TRIGGER trg_database_rows_before_update_set_updated_at
...
CREATE POLICY database_rows_isolation ON database_rows
