...
CREATE INDEX idx_canvas_nodes_workspace_page
  ON canvas_nodes(workspace_id, page_id)
  WHERE is_deleted = false;

CREATE TRIGGER trg_canvas_nodes_before_update_set_updated_at
...
CREATE POLICY canvas_nodes_isolation ON canvas_nodes
